...
main(int argc, char *argv[])
{
    ...
    /* crie a tabela de sÃ­mbolos */
    st = crieST(arqTexto);
    
    /* teste operacoes */
    testeOperacoes(st);

    /* libere a memÃ³ria ocupada pela ST */
    freeST(st);
 ...
 *  sÃ­mbolos em que as chaves sÃ£o as palavras do arquivo. 
 *  O valor correspondente a cada palavra Ã© o seu nÃºmero 
 *  de ocorrÃªncias.
 *
 *  As chaves da tabela de sÃ­mbolo sÃ£o do tipo String
...
crieST(FILE *arqTexto)
{
    ...
    while ((linha = getLine(arqTexto))) {
        ...
        while (palavra) {
            /* pegue o nÃºmero de ocorrÃªncia da palavra atÃ© o momento */
 ...
 *  TESTEOPEARCOES(ST) 
 *
 *  RECEBE uma tabela de sÃ­mbols ST e testa vÃ¡rias operaÃ§Ãµes
 *  interativamente.
 *
